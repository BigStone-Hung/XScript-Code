{@type:function}
value401=Iff(GetField("營業外收入合計","Q")>0,iff(GetField("稅前淨利","Q")>GetField("營業外收入合計","Q"),GetField("營業利益","Q"),0.01),
         maxlist(GetField("營業利益","Q"),GetField("稅前淨利","Q")));
...
value3=GetField("股東權益總額","Q")+GetField("短期借款","Q")+GetField("長期負債","Q")
       +GetField("一年內到期長期負債","Q")+GetField("應付商業本票","Q");
