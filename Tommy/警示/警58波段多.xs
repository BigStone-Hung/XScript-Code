{@type:sensor|@guid:f3a29ec3ab024c5cadd208d7fcdf9d96}
Vars: Str1("");
...
value13=maxList(value11,value12);

if close>value13 and close<value13*1.015 then begin
...
if q_PreTotalVolume>500 or q_DailyVolume>500 then begin 
   if volume>50 then begin
     if close crosses above value22 or value22>value22[1] then begin
	 ret=1;
	 RetMsg = "停損價"+Str1;
	 end;
   end;
