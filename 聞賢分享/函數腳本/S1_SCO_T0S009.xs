{@type:function|@guid:21b9eeb191104b47b6e0df502d7e53c2}
SetBarMode(0);// XQ: FTI
...
Condition2=(((COM_T0S000_SCO(5,5,5)) and (YDN_trendD(5,5,5)) and (bbwidth_trendU(C,20,2))) or ExDividendDate());
